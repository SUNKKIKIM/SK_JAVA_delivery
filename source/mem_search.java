...
public class mem_search extends JFrame {
	...
	public mem_search() {
		...
		btnNewButton.setBounds(60, 210, 90, 25);
		contentPane.add(btnNewButton);
		
		btnNewButton_1.setBounds(170, 210, 90, 25);
		contentPane.add(btnNewButton_1);
		
		btnNewButton_2.setBounds(280, 210, 90, 25);
		...
		btnNewButton_2.addActionListener(new btnNewButton_2());
		setVisible(true);
	}
	...
	public class btnNewButton_2 implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			mem_modify s = new mem_modify();
		}
	}
}
