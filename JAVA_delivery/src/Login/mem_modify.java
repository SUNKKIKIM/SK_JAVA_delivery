...
public class mem_modify extends JFrame {
	...
	public mem_modify() {
		...
		lblNewLabel_1.setBounds(12, 67, 153, 34);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel_1_1 = new JLabel("비밀번호를 입력하세요 : ");
		lblNewLabel_1_1.setBounds(12, 160, 153, 34);
		...
		te_id.setBounds(12, 107, 131, 21);
		contentPane.add(te_id);
		te_id.setColumns(10);
		
		te_pw.setBounds(12, 204, 131, 21);
	...
	public class btnNewButton_1 implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			if(b.getText().equals("확인"))
			{
				try {
					db = new database();
					result = db.modifyDB(te_name.getText(), te_phone.getText(), te_address.getText(),te_id.getText(), te_pw.getText());
					if (result == 1) {
						show = db.select_member(te_id.getText());
