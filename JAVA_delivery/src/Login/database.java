...
// 회원 정보 수정을 위한 메서드
   public int modifyDB(String name, String phone, String address, String id, String pswd) throws SQLException
   {
	   String sql = "update member set name=?, phone=?, address=? where id=? and pswd=?";
